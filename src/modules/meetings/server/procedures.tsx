...
import { MeetingStatus, StreamTrancriptItem } from '../types';
            ...
            await streamClient.upsertUsers([
                {
                    ...
                    role: "user",
                    image: generateAvatarUri({ seed: existingAgent.name, variant: "avataaarsNeutral" })
                }
            ])
    ...
    getMany: protectedProcedure
        .input(
            z.object({
                ...
                status: z.enum(MeetingStatus).nullable().optional()
            })
        ).query(async ({ input, ctx }) => {
