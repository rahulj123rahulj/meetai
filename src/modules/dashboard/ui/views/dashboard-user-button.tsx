...
const DashboardUserButton = () =>{
        ...
        return <Drawer>
            <DrawerTrigger 
                ...
                <div className="flex flex-col gap-0.5 text-left overflow-hidden flex-1 min-w-0">
                    <p className="text-sm truncate font-medium leading-none">{data.user.name}</p>
            ...
            <DrawerContent>
                <DrawerHeader>
                    <DrawerTitle className="text-sm truncate w-full">{data.user.name}</DrawerTitle>
                    <DrawerDescription className="text-sm truncate w-full">{data.user.email}</DrawerDescription>
                </DrawerHeader>
                <DrawerFooter>
                    <Button
                        variant={"outline"}
    ...
    return <DropdownMenu>
        ...
        <DropdownMenuContent align="end" side={"right"} className="w-72">
            ...
            <DropdownMenuSeparator className="border border-border my-2 text-black" />
            <DropdownMenuItem
